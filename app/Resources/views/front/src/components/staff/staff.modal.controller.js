 ...
 * File: staff.modal.controller.js
 */
...
(function () {
    ...
    angular
        .module('KindCannApp.staff.staffModal', [])
        .controller('staffModalController', staffModalController);

    staffModalController.$inject = ['$scope', '$http', 'commonService', '$log', 'toaster', 'isEdit'];

    function staffModalController($scope, $http, commonService, $log, toaster, isEdit){
