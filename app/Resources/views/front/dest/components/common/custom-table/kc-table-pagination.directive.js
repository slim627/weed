...
(function () {
  ...
  function kcTablePaginator(){
    return {
      ...
      scope: {},
      templateUrl: './components/common/custom-table/tpl/table.pagination.html',
      link: link
    };
    ...
    function link(scope, el, attr, tableCtrl){
      ...
      scope.$watch(function () {
        ...
        console.log(newVal);
        if(newVal > scope.maxPages){
          scope.currentPage = oldVal;
        }
      });
      ...
      scope.prevPage = function (){
        if(scope.currentPage > 1){
          scope.currentPage--;
          tableCtrl.currentPage = scope.currentPage;
