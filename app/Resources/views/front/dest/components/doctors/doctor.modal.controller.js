 ...
 * File: doctor.modal.controller.js
 */
...
(function () {
    ...
    angular
        .module('KindCannApp.controllers.doctorModal', [])
        .controller('doctorModalController', doctorModalController);

    doctorModalController.$inject = ['$scope', '$http', 'commonService', '$log', 'toaster', 'isEdit'];

    function doctorModalController($scope, $http, commonService, $log, toaster, isEdit){
