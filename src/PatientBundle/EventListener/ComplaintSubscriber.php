...
class ComplaintSubscriber implements EventSubscriber
{
    private $objects = [];
    ...
    public function onFlush(OnFlushEventArgs $args)
    {
        ...
        array_walk($entities, function($entity, $splObjHash){
            ...
            if ($entity instanceof Complaint && !in_array($entity, $this->objects, true)) {
        ...
        array_walk($entities, function($entity, $splObjHash){
            if (!empty($this->object)) {
                if ($entity instanceof Complaint &&  in_array($entity, $this->object, true)) {
